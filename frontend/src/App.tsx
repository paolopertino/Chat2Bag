...
function App() {
  ...
  const { jobs, schema, extractionEnabled, isPolling: isExtractionPolling, refresh: refreshJobs, cancelJob, fetchLogs } =
    useExtractionJobs();
    ...
    >
      ...
      {extractionEnabled ? (
        <ExtractDatasetDialog
          ...
          bagPath={extractBagPath}
          centerTimestampMs={
            selectedTimestampNs !== null ? Math.floor(selectedTimestampNs / 1_000_000) : 0
          }
          windowS={windowS}

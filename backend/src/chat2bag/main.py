...
from chat2bag.api.state import indexing_status
from chat2bag.core import get_app_config
from chat2bag.services.component_factory import BackendComponentFactory
from chat2bag.utils.logging_utils import setup_logging
from chat2bag.utils.paths import LOGGING_CONFIG_PATH
...
async def lifespan(fastapi_app: FastAPI):
    ...
    from chat2bag.auth.db import ensure_db_initialized
